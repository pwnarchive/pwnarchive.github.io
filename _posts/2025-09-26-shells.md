...
A basic obfuscation method is to encode a command (for example, in Base64) and then decode it at runtime for execution.

**This only works against outdated or poorly configured filters**

- Encoding techniques (Base64, URL‑encoding, XOR, etc.) can hide signatures, allowing the payload to slip very past basic detection.
